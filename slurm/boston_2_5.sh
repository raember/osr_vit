...
docker run --rm -it \
    ...
    python train_detector.py \
        ...
        --dataset Boston \
        --num-classes 7 --random-seed 412 \
        --checkpoint-path /osr-vit/experiments/save/osrclassifier_Boston_b16_bs128_lr0.01_wd1e-05_nc7_rs412_230104_064945/checkpoints/ckpt_epoch_current.pth \
        --leave-out-class 5
